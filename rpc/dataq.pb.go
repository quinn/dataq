...
func (x *PermanodeVersion) GetEmail() *rpc.Email {
...
func (x *PermanodeVersion) GetFinancialTransaction() *rpc.FinancialTransaction {
...
type PermanodeVersion_Email struct {
	Email *rpc.Email `protobuf:"bytes,6,opt,name=email,proto3,oneof"`
}

type PermanodeVersion_FinancialTransaction struct {
	FinancialTransaction *rpc.FinancialTransaction `protobuf:"bytes,7,opt,name=financial_transaction,json=financialTransaction,proto3,oneof"`
}
...
func (x *TransformResponse_Permanode) GetEmail() *rpc.Email {
...
func (x *TransformResponse_Permanode) GetFinancialTransaction() *rpc.FinancialTransaction {
...
var file_dataq_proto_goTypes = []any{
	...
	(*rpc.Email)(nil),                   // 13: dataq.Email
	(*rpc.FinancialTransaction)(nil),    // 14: dataq.FinancialTransaction
}
